            ...
            >
                        ...
                        <motion.header className="mb-12" variants={itemVariants}>
                            {logo && (
                                <div className="flex items-center">
                                    <img src={logo.url} alt={logo.alt} className="mr-3 h-12 w-12 object-contain" />
                                    <div>
                                        {logo.text && <p className="text-lg font-bold text-foreground leading-tight">{logo.text}</p>}
                                        {logo.slogan && <p className="text-xs tracking-wider text-muted-foreground">{logo.slogan}</p>}
                                    </div>
                                </div>
                            )}
                        </motion.header>
                        ...
                        <motion.main variants={containerVariants}>
                            ...
                            <motion.div variants={itemVariants}>
                                <Link
                                    ...
                                    className="text-lg font-bold tracking-widest text-primary transition-colors hover:text-primary/80 hover:underline underline-offset-4"
                                >
                                    {callToAction.text}
                                </Link>
                            </motion.div>
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        backgroundPosition: "center", // Enhanced positioning
